...
\usepackage[utf8]{inputenc}	% (auch in -Dateien)
...
\usepackage{graphicx}
\graphicspath{Bilder/}	% Angabe der Pfade, wo die Grafiken liegen; 
...
% \renewcommand{\familydefault}{rob}
% \renewcommand{\sfdefault}{rob}
...
%\include{LatexBeispiele/Einleitung}
\include{IM/Projektbericht}
